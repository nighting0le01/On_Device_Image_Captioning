...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--load_path_vizWiz",
        type=str,
        default="/home/arpitsah/Desktop/Fall-2023/odml/On_Device_Image_Captioning/vizWiz_Weights/pretrained_weightscheckpoint_2023-10-10-16:26:11_epoch4it1968bs8_xe_.pth",
    )
    parser.add_argument(
        "--image_paths",
        type=str,
        default=[
            "On_Device_Image_Captioning/demo_material/tatin.jpg",
    ...
    with open(
        "/home/arpitsah/Desktop/Fall-2023/odml/On_Device_Image_Captioning/demo_material/demo_coco_tokens.pickle",
        "rb",
    ) as f:
